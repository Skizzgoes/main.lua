...
local Library do 
    ...
    Library = {
        ...
        Folders = {
            Directory = "Cypherlib",
            Configs = "Cypherlib/Configs",
            Assets = "Cypherlib/Assets",
        },
    ...
    do
        ...
        Library.Window = function(self, Data)
            ...
            local Window = {
                ...
                SubTitle = Data.SubTitle or Data.subtitle or ".gg/XkSkNHfs5B",
            ...
            local Items = { } do
                ...
                Items["Free"] = Instances:Create("TextLabel", {
                    Parent = Items["Bottom_"].Instance,
                    Name = "\0",
                    FontFace = Library.Font,
                    TextColor3 = FromRGB(255, 255, 255),
                    TextTransparency = 0.5,
                    Text = "never expires "..Window.ExpiresIn,
                    Size = UDim2New(0, 0, 0, 15),
                    BorderSizePixel = 0,
                    BackgroundTransparency = 1,
...
Window:Page({Name = "Page2", Icon = "136879043989014"})
Window:Page({Name = "Page3", Icon = "136879043989014"})
